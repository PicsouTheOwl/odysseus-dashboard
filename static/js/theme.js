...
export const THEMES = {
  ...
  boubane:    { bg:'#1c1815', fg:'#f0e6d2', panel:'#22201c', border:'#4a3f30', red:'#d4a574',
                advanced: { sendBtnBg:'#d4a574', sendBtnHover:'#c49362',
                            userBubbleBg:'#2a2520', aiBubbleBg:'#22201c',
                            inputBg:'#252220', sidebarBg:'#1e1a17',
                            brandColor:'#d4a574', hamburgerColor:'#f0e6d2',
                            codeBg:'#1a1712', bubbleBorder:'#3a3020' } },
};

const DEFAULT_THEME = 'boubane';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Boubane Logo',    group: 'Sidebar' },
